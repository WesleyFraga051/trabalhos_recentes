...
namespace Pedincal
{
    ...
    public partial class Form2 : Form
    {
        ...
        public Form2()
        {
            ...
            this.KeyDown += Form2_KeyDown; // Associar o evento KeyDown ao manipulador de evento
        ...
        public void Variavel(out string recin, out string recfim, out int situacao, out int fil, out string codfor, out string usuario2)
        {


            //Data Recebimento 
            recin = "1" + dateTimePicker3.Value.ToString("yyMMdd");


            recfim = "1" + dateTimePicker4.Value.ToString("yyMMdd");
        ...
        private void Consulta()
        {
            ...
            Variavel(out recin, out recfim, out situacao, out fil, out codfor, out usuario2);
            ...
            string sqlQuery = "SELECT DISTINCT PED.EXT_COD_LOJ_P || DAC(PED.EXT_COD_LOJ_P) || '-' || LOJ.TIP_NOME_FANTASIA AS LOJA," +
                   ...
                   // "\r\n  AND PED.EXT_DAT_MOV_2  between " + recin + " and " + recfim + " --datamovimentação" +
